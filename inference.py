...
from managers.evaluate_score import Evaluate_score
...
def main(params):
    ...
    for r in range(1, params.runs + 1):
        ...
        params.db_path = os.path.join(params.main_dir, f'data/{params.dataset}/{params.test_file}_subgraphs_{params.experiment_name}_{params.constrained_neg_prob}_en_{params.enclosing_sub_graph}')
        ...
        test_evaluator = Evaluate_score(params, graph_classifier, test)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_links", type=int, default=100000000,
                        help="Set maximum number of links (to fit into memory)")
    parser.add_argument("--hop", type=int, default=3,
                        help="Enclosing subgraph hop number")
    parser.add_argument("--max_nodes_per_hop", "-max_h", type=int, default=256,
